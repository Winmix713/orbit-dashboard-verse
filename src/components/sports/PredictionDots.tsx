...
const PredictionDots = ({ selectedPrediction, onSelectPrediction }: PredictionDotsProps) => {
  return (
    <div className="flex gap-1.5 mt-1">
      <button
        className={cn(
          "w-2 h-2 rounded-full transition-all duration-200",
          selectedPrediction === "home" ? "bg-blue-500" : "bg-white/20 hover:bg-white/30",
        )}
      ...
      <button
        className={cn(
          "w-2 h-2 rounded-full transition-all duration-200",
          selectedPrediction === "draw" ? "bg-blue-500" : "bg-white/20 hover:bg-white/30",
        )}
      ...
      <button
        className={cn(
          "w-2 h-2 rounded-full transition-all duration-200",
          selectedPrediction === "away" ? "bg-blue-500" : "bg-white/20 hover:bg-white/30",
        )}
